...
load ~/Research/EMOD/Basil1/flights_network/countries/USA/data/usagflu.mat
...
alpha_0 = R_0*beta; % infection rate per unit infected
...
if fakey==1
    ...
    if strcmp(country,'USA') == 1
        load /Users/gustafsonkyle/Research/EMOD/Basil1/flights_network/countries/USA/data/transferUSA.mat
...
load /Users/gustafsonkyle/Research/EMOD/Basil1/flights_network/countries/USA/data/usadata.mat usaorigin
...
total_indiv = round(1000.*nn./mean(nn(tophubsUSA)))+100; % 100 sets a minimum
...
elseif strcmp(algorithm,'tauleap')==1
    [final_state,time_vector] = ...
        tauleapdiffusion(rates, end_time, initial_states, transfer_prob, transfer_int, hubsUSA, minpop, startfly_time, cycle_period, cycle_phase, cycle_x, alpha_0, gflu, top10usagflufloor);
else
    error('invalid algorithm')
end
