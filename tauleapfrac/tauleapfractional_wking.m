    ...
    elseif grid_dim=='2d'
        ...
        for idx = 1:num_channels
            ...
            for nodepointx=1:num_nodesx % move in x, compute the y line
                BigG2 = frac_kernel(tau,ffmu2da,hfracgrid2da,num_nodesy,alphafrac,center,Dalpha);
                XXX = nodepointx;
...
%                    kvector = mnrnd(lineput(lambda),BigG2rc);
            ...
            for nodepointy=1:num_nodesy %  move in Y, compute the X line
                BigG2 = frac_kernel(tau,ffmu2da,hfracgrid2da,num_nodesx,alphafrac,center,Dalpha);
                YYY = nodepointy;
